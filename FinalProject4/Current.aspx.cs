...
namespace FinalProject4
{
    public partial class Current : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            wishlist = getCurrentlyPlaying(Session["username"].ToString());
        ...
        public LinkedList<int> getCurrentlyPlaying(string username)
        {
            ...
            Conn.Open();
            string cmdstring = "Select * from userPlaying where Username = @username";
